...
- **macOS permissions**: Hammerspoon/Terminal need Screen Recording + Accessibility granted for capture and hotkeys to work. If a capture silently fails, check permissions before assuming a code bug — surface this to Shiyaa rather than debugging blind.
